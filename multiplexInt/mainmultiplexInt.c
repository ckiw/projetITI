...
//à l'appui sur un bouton situe sur RB0/INT0/pin 33 change l'état d'une led en XX (il
// faut penser à enlever le cavalier des leds car RB0 est relié avec)
...
BOOL consigneClignoDroit = 0;
BOOL consigneClignoGauche = 0;
...
void main() {
    ...
    TRISDbits.TRISD0 = 1; // rd0 en entrée (bouton)
    TRISDbits.TRISD1 = 1; // rd1 en entrée (bouton)
    ...
    ECANSendMessage(0x224, 0, 8, 0b00000011);
